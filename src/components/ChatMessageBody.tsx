    ...
    return (
      <div className="space-y-3">
        <p className="text-sm leading-relaxed text-slate-700 dark:text-neutral-300">
          Scoring is complete. Review the ranked markets below, then choose one in the
          card underneath.
        </p>
  ...
  if (message.subtitle) {
    return (
      <div className="space-y-2">
        <p className="whitespace-pre-line break-words [overflow-wrap:anywhere] text-[0.9375rem] leading-6 text-slate-800 dark:text-neutral-100 sm:text-sm sm:leading-7">
          {message.content}
        </p>
